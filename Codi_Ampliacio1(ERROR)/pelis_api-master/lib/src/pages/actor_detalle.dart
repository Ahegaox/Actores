...
class ActorDetalle extends StatelessWidget {
    ...
    return SliverAppBar(
      ...
      flexibleSpace: FlexibleSpaceBar(
        ...
        background: FadeInImage(
          image: NetworkImage("https://image.tmdb.org/t/p/w500" + pelicula.profilePath),
          ...
          Flexible(
            child: Column(
              ...
              children: <Widget>[
                ...
                Text(actor.name, style: Theme.of(context).textTheme.bodyText1, overflow: TextOverflow.ellipsis),
                Row(
                  children: <Widget>[Icon(Icons.star_border), Text(actor.name, style: Theme.of(context).textTheme.bodyText1)],
                )
              ],
            ),
          )
  ...
  Widget _crearCasting(Actor actor) {
    ...
    return FutureBuilder(
      future: peliProvider.getCredit(actor.id.toString()),
